...
export function CreateRestaurantForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const created = data.restaurante;
    ...
    <div className="container d-flex justify-content-center align-items-start py-5" style={{ minHeight: "100vh" }}>
      <div className="col-12 col-md-8 col-lg-6">
        <div className="card shadow-sm border-0">
          ...
          <div className="card-body" style={{ backgroundImage: 'url("/fondo.jpg")', backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backdropFilter: "blur(6px)", borderRadius: "10px" }}>
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="mb-3">
                ...
                <input id="name" type="text" className="form-control" placeholder="Ej: Casa Danonino" value={name} onChange={(e) => setName(e.target.value)} required />
              </div>

              <div className="mb-3">
                <label htmlFor="direccion" className="form-label">Dirección (opcional)</label>
                <input id="direccion" type="text" className="form-control" placeholder="Calle Ejemplo 123" value={direccion} onChange={(e) => setDireccion(e.target.value)} />
              </div>

              <div className="mb-3">
                <label htmlFor="telefono" className="form-label">Teléfono (opcional)</label>
                <input id="telefono" type="tel" className="form-control" placeholder="666 123 456" value={telefono} onChange={(e) => setTelefono(e.target.value)} />
              </div>

              <button type="submit" className="btn w-100 mb-3 text-white" style={{ backgroundColor: "rgb(59, 74, 99)" }} disabled={loading || !name.trim()}>
